...
CameraParameters::CameraParameters(QWidget *parent)
    : QWidget(parent), ui(new Ui::CameraParameters), mCameras(CameraManager::getInstance())
{
    ui->setupUi(this);
}
...
void CameraParameters::updateCamera(QString cameraName)
{
...
void CameraParameters::on_hs_gain_valueChanged(int value)
{
    ui->sbx_gain->setValue(value);
}

void CameraParameters::on_sbx_gain_valueChanged(int arg1)
{
    ui->hs_gain->setValue(arg1);
    mCameras->setGain(mCameraName, arg1);
}

void CameraParameters::on_hs_exposure_valueChanged(int value)
{
    ui->sbx_exposure->setValue(value);
}

void CameraParameters::on_sbx_exposure_valueChanged(int arg1)
{
    ui->hs_exposure->setValue(arg1);
    mCameras->setExposureTime(mCameraName, arg1);
}

void CameraParameters::on_hs_frameRate_valueChanged(int value)
{
    ui->sbx_frameRate->setValue(value);
}

void CameraParameters::on_sbx_frameRate_valueChanged(int arg1)
{
    ui->hs_frameRate->setValue(arg1);
    mCameras->setAcquisitionFrameRate(mCameraName, arg1);
}

void CameraParameters::on_hs_width_valueChanged(int value)
{
    ui->sbx_width->setValue(value);
}

void CameraParameters::on_sbx_width_valueChanged(int arg1)
{
    ui->hs_width->setValue(arg1);
    mCameras->setWidth(mCameraName, arg1);
}

void CameraParameters::on_hs_height_valueChanged(int value)
{
    ui->sbx_height->setValue(value);
}

void CameraParameters::on_sbx_height_valueChanged(int arg1)
{
    ui->hs_height->setValue(arg1);
    mCameras->setHeight(mCameraName, arg1);
}

void CameraParameters::on_hs_xoffset_valueChanged(int value)
{
    ui->sbx_xoffset->setValue(value);
}

void CameraParameters::on_sbx_xoffset_valueChanged(int arg1)
{
    ui->hs_xoffset->setValue(arg1);
    mCameras->setoffsetX(mCameraName, arg1);
}

void CameraParameters::on_hs_yoffset_valueChanged(int value)
{
    ui->sbx_yoffset->setValue(value);
}

void CameraParameters::on_sbx_yoffset_valueChanged(int arg1)
{
    ui->hs_yoffset->setValue(arg1);
    mCameras->setoffsetY(mCameraName, arg1);
}

void CameraParameters::initParams(QString &name)
{
...
void CameraParameters::on_btn_save_clicked()
{
    // 保存参数
    // 编号
...
void CameraParameters::on_cbx_pixFormat_currentTextChanged(const QString &arg1)
{
